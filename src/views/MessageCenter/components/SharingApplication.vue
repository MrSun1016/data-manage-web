                    ...
                    <div class="left-box">
                      ...
                      <p>
                        <el-tooltip
                          ...
                          placement="top"
                        >
                          <p ref="tooltipBox" class="item-info conceal1">
                      ...
                      <p>
                        <span class="item-title item-title1">申请类型：</span
                        ><span class="item-info">{{ gxCategoryApplyBo.flowList[0].shareType || '-' }}</span>
                      </p>
                    ...
                    <div class="right-box">
                      ...
                      <p>
                        <el-tooltip
                          ...
                          placement="top"
                        >
                          <p ref="tooltipBox" class="conceal1">
                            <span class="item-title" style="width: 157px;">资源服务申请表：</span>
                            <span ref="tooltipItem"  @click="downLoad" style="cursor: pointer">
                  ...
                  <div class="examine-box" style="min-height: 100px">
                    ...
                    <div style="color: #333">
                      <div  class="share-df">
                        ...
                        <div v-if="gxCategoryApplyBo.flowList[1].deptName != null" style="font-size: 12px;" class="share-df-info">
                          <span class="item-info"
                            >审批部门：{{ gxCategoryApplyBo.flowList[1].deptName || '-' }}</span
                          ><span v-show="gxCategoryApplyBo.flowList[1].assigneeName&&gxCategoryApplyBo.flowList[1].phone" class="item-info" style="margin: 0 24px"
                            >审批人：{{ gxCategoryApplyBo.flowList[1].assigneeName || '-' }}</span
                          ><span v-show="gxCategoryApplyBo.flowList[1].assigneeName&&gxCategoryApplyBo.flowList[1].phone" class="item-info">联系电话：{{ gxCategoryApplyBo.flowList[1].phone || '-' }}</span>

                          <span v-show="gxCategoryApplyBo.flowList[1].manyPeople" class="item-info" style="margin: 0 24px"
                          >审批人(联系电话)：{{ gxCategoryApplyBo.flowList[1].manyPeople || '-' }}</span>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="examine-two">
                        <div v-if="shareType != '接口'">
                          <div style="color: #333; background: #f8fafb; padding-left: 24px">
                            申请数据项：<span style="font-size: 12px"
                              >（提示：<span style="color: #1890ff">蓝色文字</span>为有条件共享；<span
                                style="color: black"
                                >黑色文字</span
                              >
                              为无条件共享；<span style="color: red">红色文字</span
                              >为不予共享，若同意共享请选中该字段）</span
                            >
                          </div>
                          <!-- 复选框 -->
                        ...
                        <div>
                          <div v-if="shareType != '接口'" class="preview-box">
                            <div class="preview-left">
                              <div style="width: 100px">数据归集时间：</div>
                            </div>
                      ...
                      <div class="examine-two">
                        ...
                        <div>
                          ...
                          <div v-if="shareType != '接口'" class="preview-box">
                            ...
                            <div class="preview-right">
                              <div v-if="gxCategoryApplyBo.flowList.length > 2">
                                {{ gxCategoryApplyBo.flowList[1].dataStartTime || '-' }}
                              </div>
                            </div>
                            <div class="preview-left">
                            ...
                            <div class="preview-right">
                              <div v-if="gxCategoryApplyBo.flowList.length > 2">
                                {{ gxCategoryApplyBo.flowList[1].dataEndTime || '-' }}
                              </div>
                            </div>
                          </div>
                          <!-- 审批意见 -->
                          <div class="approval-opinion">
                            ...
                            <div class="opinion-right">
                              ...
                              <div v-else>{{ gxCategoryApplyBo.flowList[1].approvalRemark || '-' }}</div>
                            </div>
                          </div>
                          <div
                  ...
                  <div class="share-df">
                   <div>
                    ...
                    >
                      ...
                      ><span v-show="gxCategoryApplyBo.flowList[2].assigneeName&&gxCategoryApplyBo.flowList[2].phone" class="item-info" style="margin: 0 24px"
                        >审批人：{{ gxCategoryApplyBo.flowList[2].assigneeName || '-' }}</span
                      ><span v-show="gxCategoryApplyBo.flowList[2].assigneeName&&gxCategoryApplyBo.flowList[2].phone" class="item-info">联系电话：{{ gxCategoryApplyBo.flowList[2].phone || '-' }}</span>
                      
                      <span v-show="gxCategoryApplyBo.flowList[2].manyPeople" class="item-info" style="margin: 0 24px"
                        >审批人(联系电话)：{{ gxCategoryApplyBo.flowList[2].manyPeople || '-' }}</span>
                    </div>
                  </div>
                  <!-- 说明 -->
...
export default {
  ...
  methods: {
    ...
    onApproved() {
      ...
      this.reqGxCategoryApplyBo.dataStartTime = this.collectionTime[0]
      this.reqGxCategoryApplyBo.dataEndTime = this.collectionTime[1]
    ...
    fetchSourceDepartmentApproval(fromItem, itemId, formInline) {
      ...
      getSourceDepartmentApproval(this.completeByDateId.processCode).then((res) => {
        if (res.success) {
          ...
          this.gxCategoryApplyBo.flowList[1].dataEndTime = this.formatTime(
            this.gxCategoryApplyBo.flowList[1].dataEndTime,
            'hms'
          )
          this.gxCategoryApplyBo.flowList[1].dataStartTime = this.formatTime(
            this.gxCategoryApplyBo.flowList[1].dataStartTime,
            'hms'
          )
